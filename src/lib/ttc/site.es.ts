  ...
  legal: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { h: 'Cómo se almacena', p: 'Las solicitudes se guardan en nuestra base de datos de proyectos y los adjuntos en almacenamiento privado en la nube; se envía una notificación por correo electrónico a la oficina a través de un proveedor de correo transaccional para que veamos su mensaje, y se le envía una confirmación a usted. El acceso se limita a las personas que lo necesitan para responderle.' },
