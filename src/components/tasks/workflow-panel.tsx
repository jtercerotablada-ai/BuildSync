...
const organizeItems = [
  {
    ...
    label: "Campos",
    icon: CircleDot,
    description: "Personalizar campos para este proyecto",
  },
];
...
const automateItems = [
  {
    ...
    label: "Reglas",
    icon: Zap,
    description: "Automatizar acciones con reglas",
  },
  {
    id: "apps",
    label: "Aplicaciones",
      ...
      {open && (
        <>
          ...
          <div className="flex items-center justify-between px-5 pt-5 pb-3">
            <h2 className="text-[18px] font-semibold text-gray-900">Flujo de trabajo</h2>
            <button
              onClick={onClose}
          ...
          <div className="px-5 pb-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[13px] font-semibold text-gray-900">Este proyecto</p>
                <p className="text-[12px] text-gray-400 mt-0.5">Ver y editar funciones en este proyecto</p>
              </div>
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-44">
                  <DropdownMenuItem
                    onClick={() => toast.info("Agregar campo próximamente")}
                  ...
                  <DropdownMenuItem
                    onClick={() => toast.info("Agregar regla próximamente")}
                    className="cursor-pointer text-[13px]"
                  >
                  ...
                  <DropdownMenuItem
                    onClick={() => toast.info("Conectar aplicación próximamente")}
                    className="cursor-pointer text-[13px]"
                  >
              ...
              <div className="space-y-1">
                {organizeItems.map((item) => {
                  ...
                  return (
                    <button
                      key={item.id}
                      onClick={() => toast.info(`Configuración de ${item.label} próximamente`)}
