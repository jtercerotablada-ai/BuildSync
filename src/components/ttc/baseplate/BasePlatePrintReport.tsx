  ...
  const body = (
    <div className="slab-print-portal" id="slab-print-portal">
      ...
      <section className="pr-page pr-cover">
        ...
        <div className="pr-disclaimer">
          ...
          <p>
            ...
            established structural-analysis software and <strong>reviewed, signed, and sealed
      ...
      <section className="pr-page">
        ...
        <p className="pr-meta">For this design ({input.anchors.da.toFixed(3)}″ rods): horizontal placement tolerance is <strong>±{lookupAnchorTolerance(input.anchors.da).toFixed(3)}″</strong> from specified location. Specify ACI 117-10 in MasterFormat Division 03 to clearly establish basis for acceptance.</p>
      ...
      <section className="pr-page">
        ...
        <ol className="pr-notes-list">
          ...
          <li>Grouting is the responsibility of the concrete contractor (DG1 §4.5.6 recommendation). Specify in MasterFormat Division 03.</li>
