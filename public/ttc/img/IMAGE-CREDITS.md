# Home / Projects image credits

Project-showcase and team photos used on the public site, sourced from
**Wikimedia Commons**. Most are licensed **CC BY-SA** (attribution + share-alike);
two are CC0 / public domain. Attribution below satisfies the license terms.

> Recommendation: replace these with real **Tercero Tablada** project photography
> before/at public launch where possible — that removes any attribution obligation
> and makes the showcase genuinely represent the firm's work.
...
| projects/project-07.jpg | Parking Structure | Philip Jeffrey | CC BY-SA 2.0 | https://commons.wikimedia.org/wiki/File:Queensway_multi_storey_car_park_-_geograph.org.uk_-_2860457.jpg |
| projects/project-08.jpg | Mixed-Use | PattayaPatrol | CC BY-SA 4.0 | https://commons.wikimedia.org/wiki/File:DFC_1615_A_cityscape_of_mixed_low-rise_and_high-rise_buildings_with_a_distant_tower_under_construction_against_a_pale_sky.jpg |
| projects/project-09.jpg | Healthcare (Firman Desloge Hospital, SLU Medical Center) | Wikimedia Commons | CC BY-SA 2.0 | https://commons.wikimedia.org/wiki/File:Firman_Desloge_Hospital_Building,_St._Louis_University_Medical_Center,_Grand_Boulevard,_The_Gate,_St._Louis,_MO_-_54223708669.jpg |
